                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="input-group-append">
                                        <a href="{{route('admin.view_category_option')}}" class="btn btn-sm btn-info" type="">Xem thuộc tính sản phẩm đã tạo</a>
                                    </div>                  
                                </div>   
                            </div>
                            ...
                            @foreach ($categories as $category)
                                <div class="form-group">
                                    <div class="input-group">
                                       ...
                                       @endif     
                                       <input style="{{$category->parent_id == 0 ? 'color: red;' : '#fff'}}" type="text" class="form-control" value="{{$category->category_name}}">
                                        <div class="input-group-append">
                                            <a href="{{url('delete_category',$category->id)}}" class="btn btn-sm btn-danger" type="Delete">Xóa</a>
                                        </div>
                                        <div class="input-group-append">
                                            <a href="{{url('edit_category',$category->id)}}" class="btn btn-sm btn-warning" type="Edit">Sửa</a>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
